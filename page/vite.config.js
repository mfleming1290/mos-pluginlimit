...
const PLUGIN_VERSION =
  process.env.PLUGIN_VERSION || pluginConfig.version;
...
export default defineConfig({
  ...
  build: {
    ...
    // MOS loads plugin files directly from /var/www/mos-plugins/<name>/.
    // Keep federation assets at the plugin root instead of dist/<name>/assets/.
    assetsDir: '',

    // A MOS plugin is a remote module, not a standalone Vite application.
    rollupOptions: {
      input: {},
    },
  },
